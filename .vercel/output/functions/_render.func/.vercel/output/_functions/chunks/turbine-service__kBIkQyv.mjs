...
function calculateOptimalOperation(windSpeed, windDirection) {
...
export { getMaintenanceSchedule as a, getAlerts as b, calculateOptimalOperation as c, getTurbines as g };
